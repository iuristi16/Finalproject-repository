...
Add extends BrowserAction {
    ...
    @Test
    @Description("აღნიშნული ტესტი შესაძენ ყველაზე ძვირიან პროდუქტს ამატებს ბარათზე")
    public void AddProdact() {
        AddProdactStep step2 = new AddProdactStep(driver);
        ...
        String
                ...
                actualResult = driver.findElement(By.xpath("//*[@id=\"item_5_title_link\"]/div")).getText();
